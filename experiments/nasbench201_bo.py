...
if __name__ == "__main__":
    ...
    for dataset_name, n_workers, max_wallclock_time in tqdm(combinations):
        print("\nNAS-Bench-201,", dataset_name, ", n_workers =", n_workers, ", max_wallclock_time =",
              max_wallclock_time)
        ...
        # TODO: check 'search options'; some explanation: Using ``restrict_configurations``,
        #  we restrict the scheduler to only suggest configurations which have observations
        #  in the tabulated blackbox
