...
if __name__ == "__main__":
    ...
    # dataset_name_list = ["cifar100", "ImageNet16-120"]
    ratio_list = [0.2]
    n_workers = 4
    max_wallclock_time_list = [3600 * 2]
    # max_wallclock_time_list = [
    #     10, 60, 360, 600, 1200, 1500, 1800, 3000,
    #     3600, 2 * 3600, 3 * 3600, 4 * 3600, 5 * 3600,
    #     6 * 3600, 7 * 3600,
    #      ]
    combinations = list(
    ...
    for dataset_name, ratio, max_wallclock_time in tqdm(combinations):
        print("\nNAS-Bench-201,", dataset_name, ", ratio =", ratio, ", max_wallclock_time =", max_wallclock_time)
