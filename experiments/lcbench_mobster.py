...
"""
Running MOBSTER on the "lcbench" tabulated benchmark.
...
if __name__ == "__main__":
    ...
    dataset_name_list = ["Fashion-MNIST", "airlines", "albert", "covertype"]
    # dataset_name_list = ["Fashion-MNIST", "airlines", "albert", "christine"]
    n_workers_list = [4]
    ...
    max_wallclock_time_list = [10, 60, 360, 600, 1000, 1200, 1500, 1800, 3000, 3600, 2 * 3600, 3 * 3600, 4 * 3600]
    combinations = list(
    ...
    for dataset_name, n_workers, max_wallclock_time in tqdm(combinations):
        print("\nlcbench,", dataset_name, ", n_workers =", n_workers, ", max_wallclock_time =",
              max_wallclock_time)
